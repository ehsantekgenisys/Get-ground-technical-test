...
class Table extends React.Component {
  ...
  render() {
    ...
    const columns = [
      ...
      { title: "Book Publication City", field: "book_publication_city" },
      { title: "Book Publication Country", field: "book_publication_country", type: "numeric" },
      { title: "Book Publication Year", field: "book_publication_year" },
      { title: "Book Pages", field: "book_pages" },
